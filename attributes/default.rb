...
default['tomcat-all']['auto_deploy'] = true

# SSL Connector
default['tomcat-all']['ssl_enabled'] = false
default['tomcat-all']['ssl_port'] = ''
default['tomcat-all']['ssl_protocol'] = 'TLS'
...
default['tomcat-all']['access_logs']['directory'] = 'logs'
default['tomcat-all']['access_logs']['prefix'] = 'localhost_access_log.'
default['tomcat-all']['access_logs']['suffix'] = '.txt'
default['tomcat-all']['access_logs']['pattern'] = '%h %l %u %t &quot;%r&quot; %s %b'
default['tomcat-all']['access_logs']['max_days'] = '-1'
